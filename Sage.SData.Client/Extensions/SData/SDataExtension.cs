...
namespace Sage.SData.Client.Extensions
{
    ...
    public class SDataExtension : SyndicationExtension, ISyndicationExtension
    {
        ...
        /// </summary>
        private SDataExtensionContext _extensionContext = new SDataExtensionContext();
        ...
        /// <summary>
        /// Gets or sets the <see cref="SDataExtensionContext"/> object associated with this extension.
        /// </summary>
        /// <value>A <see cref="SDataExtensionContext"/> object that contains information associated with the current syndication extension.</value>
        /// <remarks>
        ...
        public SDataExtensionContext Context
        {
        ...
        public static bool MatchByType(ISyndicationExtension extension)
        {
            ...
            //------------------------------------------------------------
            return extension.GetType() == typeof (SDataExtension);
        }
